...
<body class="cbp-spmenu-push">
    ...
    ?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h2 class="title1">feedback display</h2>
					    <div class="bs-example widget-shadow" data-example-id="hoverable-table"> 
                            <h4>feedback details : <a href="add-feedback.php"> <img style='width:20px;' src='myimages/add.png'></a></h4>
    ...
    while($feedbackrow = mysqli_fetch_array($selectq))
    {
        echo "<tr>";
            ...
            echo "<td><a href ='edit-feedback.php?eid={$feedbackrow['feedback_id']}'><img style='width:16px;' src='myimages/editing.png'> Edit</a> |  <a href ='display-feedback.php?did={$feedbackrow['feedback_id']}'><img style='width:16px;' src='myimages/delete.png'> delete </a></td>";
        echo "<tr>";
