...
if($_POST)
{
	...
	$query = mysqli_query($connection, "insert into tbl_company(company_name,company_details) values('{$name}','{$details}')") or die (mysqli_error($_connection));
				...
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="cname" placeholder="Enter name "required> 
                              
						</div>		
						<div class="form-group">
                            <label for="exampleInputPassword2"required> company Detail :</label>
                             
							  <textarea class="form-control" name="cdetail"></textarea>
                        </div>
