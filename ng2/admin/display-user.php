...
<body class="cbp-spmenu-push"> 
    ...
    ?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h2 class="title1">User Name display</h2>
					    <div class="bs-example widget-shadow" data-example-id="hoverable-table"> 
                            <h4>User details : <a href="add-User.php"> <img style='width:20px;' src='myimages/add.png'></a></h4>
    ...
    while($userrow = mysqli_fetch_array($selectq))
    {
        echo "<tr>";
            ...
            // echo"<td>{$userrow['user_dob']}</td>";
            // echo"<td>{$userrow['user_gender']}</td>";
            echo"<td>{$userrow['user_mobile']}</td>";
            echo"<td>{$userrow['user_email']}</td>";
            echo"<td>{$userrow['user_address']}</td>";

             echo "<td><a href ='edit-user.php?eid={$userrow['user_id']}'><img style='width:16px;' src='myimages/editing.png'> Edit</a> |  <a href ='display-user.php?did={$userrow['user_id']}'><img style='width:16px;' src='myimages/delete.png'> delete </a></td>";
        echo "<tr>";
